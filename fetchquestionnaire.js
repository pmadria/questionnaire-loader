...
//function fetchArtifacts(fhirPrefix, filePrefix, questionnaireReference, fhirVersion consoleLog) {
function fetchArtifacts(questionnaireReference, fhirVersion consoleLog) {
  return new Promise(function(resolve, reject) {
    ...
    function resolveIfDone(){
      ...
      if (retVal.questionnaire) resolve(retVal);
    ...
    pendingFetches += 1;
    consoleLog("fetching questionnaire", "infoClass");
